...
class GraphInterface
{
    ...
    private :
        ...
        grman::WidgetText m_supprimertxt;
        grman::WidgetButton m_sauvegarder;
        grman::WidgetText m_sauvegardertxt;
        grman::WidgetButton m_ajouterS;
        grman::WidgetText m_ajouterStxt;
        grman::WidgetButton m_ajouterA;
        grman::WidgetText m_ajouterAtxt;
        grman::WidgetButton m_connexe;
        grman::WidgetText m_connexetxt;
        grman::WidgetButton m_clavier;
        grman::WidgetText m_claviertxt;
        grman::WidgetButton m_quitter;
        grman::WidgetText m_quittertxt;
...
class Graph
{
    ...
    public:
        ...
        ///Nos sous-programme pour ajouter sommet, arc, supprimer sommet + arc ou sauvegarder graph
        void ajoutS();
        void ajoutA();
        void sauvegarde(Graph g,std::string name);
        void deleteS(int eidx);

        ///Sous-programme pour la connexité
        void connexite();

        ///Sous-programme d'affichage de nos bitmap à l'aide des boutons
        void afficherBye();
        void afficherClavier();

        ///Sous-programme d'évolution dynamique

        void EvolutionDynamique();
};
